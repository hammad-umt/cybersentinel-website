    ...
    >
      <div className="section-container flex h-16 items-center justify-between md:h-[4.5rem]">
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-md text-muted hover:bg-white/5 md:hidden"
            ...
            <nav className="section-container flex flex-col gap-1 py-4">
              {NAV_LINKS.map((link) => (
                <a
                  ...
                  className="rounded-md px-3 py-2.5 text-sm text-muted hover:bg-white/5 hover:text-foreground"
                >
                  {link.label}
                </a>
              ))}
